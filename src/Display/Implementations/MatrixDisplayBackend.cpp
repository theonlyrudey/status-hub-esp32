...
void MatrixDisplayBackend::renderNotificationBitmap(const NotificationBitmapView &notification) const {
    if (notification.bitmap != nullptr) {
        _bitmapDrawer.drawBitmap8x8(notification.bitmap);
        return;
    }
...
void MatrixDisplayBackend::renderNotificationBitmapDetailed(const NotificationBitmapDetailedView &notification) const {
    if (notification.bitmap != nullptr) {
        _bitmapDrawer.drawBitmap8x8(notification.bitmap);
        return;
    }
