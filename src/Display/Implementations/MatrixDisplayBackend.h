...
private:
    ...
    void renderNotificationBitmap(const NotificationBitmapView &notification) const;
    void renderNotificationBitmapDetailed(const NotificationBitmapDetailedView &notification) const;
