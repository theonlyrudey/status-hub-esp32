...
struct NotificationBitmapView { const std::uint8_t *bitmap; std::string body; std::uint8_t severity; };
struct NotificationBitmapDetailedView { const std::uint8_t *bitmap; std::string title; std::string body; std::uint8_t severity; };
...
using DisplayScene = std::variant<TextLine, NotificationView, NotificationBitmapView, NotificationBitmapDetailedView, ProgressView, StatusView, Bitmap8x8View>;
